    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow">
        <div className="container-custom py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-800">Provisionamento de Vendas</h1>
      ...
      <main className="container-custom py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="card">
            <h3 className="text-gray-600 text-sm font-medium mb-2">Pedidos Pendentes</h3>
            <p className="text-3xl font-bold text-yellow-600">0</p>
          </div>
          <div className="card">
            <h3 className="text-gray-600 text-sm font-medium mb-2">Receita Total</h3>
            <p className="text-3xl font-bold text-green-600">R$ 0,00</p>
          </div>
          <div className="card">
            <h3 className="text-gray-600 text-sm font-medium mb-2">Previsão Mês</h3>
